...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String pekerjaan, String warganegara, String berlakuhingga, byte[] foto) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
