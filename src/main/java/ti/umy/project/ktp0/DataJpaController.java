...
import ti.umy.project.ktp0.exceptions.NonexistentEntityException;
import ti.umy.project.ktp0.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy_project.ktp.110_jar_0.0.1-SNAPSHOTPU");
